...
function changeStatus() {
      console.log(orderid);
      if (status1 = "taked_by_rt") {
        status2 = "taked_by_alliance";
        console.log(status2);
      } else if (status1 = "taked_by_alliance") {
        status2 = "prepared";
        console.log(status2)
      } else if (status1 = "prepared") {
        status2 = "delivered_to_rt"
        console.log(status2)
      }
...
$("form").submit(function() {
      ...
      $.ajax({
        ...
        $.ajax({
        type: "GET",
        url: "http://52.10.76.37/alien/public/orders/palmitos?type=in_progress",
        dataType: "json",
        success : function(data) {
                      json = data;
                      if (json.length == 0) {
                      ...
                      for (i = 0; i < json.length; i++){
                          ...
                          $('#enprogresoordenesTab').append(new_orders1);
                          $('#enprogresoordenesTab').addClass("animated bounceInUp");
                          for (h = 0; h < products.length; h++){ 
                            order_data = "<tr>" + "<td>" + data[i].products[h].units + "</td>" + "<td>" + data[i].products[h].name + "</td>" + "<td>" + "</td>" + "</tr>";
                            collapsible = "#tbody" + [i];
        ...
        success : function(data) {
                      ...
                      for (i = 0; i < json.length; i++){
                          ...
                          $('#finalizadasordenesTab').append(new_orders1);
                          $('#finalizadasordenesTab').addClass("animated bounceInUp");
                          for (h = 0; h < products.length; h++){ 
                            order_data = "<tr>" + "<td>" + data[i].products[h].units + "</td>" + "<td>" + data[i].products[h].name + "</td>" + "<td>" + "</td>" + "</tr>";
                            collapsible = "#tbody" + [i];
