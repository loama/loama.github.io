...
for(var k=0;k<l.length;k++){m(l[k])}return m})({1:[function(d,g,f){g.exports={log:d("./ac-console/log")}
},{"./ac-console/log":2}],2:[function(l,k,h){var i="f7c9180f-5c45-47b4-8de4-428015f096c0";
...
}}},{}],3:[function(g,j,h){var k={};k.addEventListener=function(a,c,b,d){if(a.addEventListener){a.addEventListener(c,b,d)
...
};j.exports=k},{}],4:[function(d,g,f){g.exports.DOMEmitter=d("./ac-dom-emitter/DOMEmitter")
},{"./ac-dom-emitter/DOMEmitter":5}],5:[function(h,m,i){var k;var l=h("ac-event-emitter").EventEmitter;
...
};m.exports=j},{"ac-event-emitter":false}],6:[function(d,g,f){g.exports.WindowDelegate=d("./window-delegate/WindowDelegate");
g.exports.windowEmitter=d("./window-delegate/windowEmitter")},{"./window-delegate/WindowDelegate":7,"./window-delegate/windowEmitter":8}],7:[function(m,k,i){var j;
...
}else{if(a){this.trigger("scrollStop")}}};k.exports=new l()},{"./windowEmitter":8}],8:[function(f,i,g){var h=f("ac-dom-emitter").DOMEmitter;
i.exports=new h(window)},{"ac-dom-emitter":4}],9:[function(f,i,g){var h=f("./ac-element-tracker/ElementTracker");
i.exports=new h();i.exports.ElementTracker=h},{"./ac-element-tracker/ElementTracker":10}],10:[function(z,A,w){var v;
...
}return c};A.exports=B},{"./TrackedElement":11,"ac-base":false,"ac-event-emitter":false,"ac-object":13,"window-delegate":6}],11:[function(h,m,i){var l;
...
m.exports=k},{"ac-dom-emitter":4}],12:[function(Q,V,B){var G=Object.prototype.toString;
var N=Object.prototype.hasOwnProperty;var W=typeof Array.prototype.indexOf==="function"?function(a,b){return a.indexOf(b)
...
}catch(a){return b}}},{}],13:[function(d,g,f){g.exports={clone:d("./ac-object/clone"),create:d("./ac-object/create"),defaults:d("./ac-object/defaults"),extend:d("./ac-object/extend"),getPrototypeOf:d("./ac-object/getPrototypeOf"),isDate:d("./ac-object/isDate"),isEmpty:d("./ac-object/isEmpty"),isRegExp:d("./ac-object/isRegExp"),toQueryParameters:d("./ac-object/toQueryParameters")}
},{"./ac-object/clone":14,"./ac-object/create":15,"./ac-object/defaults":16,"./ac-object/extend":17,"./ac-object/getPrototypeOf":18,"./ac-object/isDate":19,"./ac-object/isEmpty":20,"./ac-object/isRegExp":21,"./ac-object/toQueryParameters":22}],14:[function(g,k,h){var i=g("./extend");
k.exports=function j(a){return i({},a)}},{"./extend":17}],15:[function(g,j,h){var i=function(){};
...
return new i()}}},{}],16:[function(g,k,h){var i=g("./extend");k.exports=function j(a,b){if(typeof a!=="object"){throw new TypeError("defaults: must provide a defaults object")
}b=b||{};if(typeof b!=="object"){throw new TypeError("defaults: options must be a typeof object")
}return i({},a,b)}},{"./extend":17}],17:[function(k,j,g){var h=Object.prototype.hasOwnProperty;
...
}}}});return b}},{}],18:[function(k,j,g){var h=Object.prototype.hasOwnProperty;
...
a.constructor=b}return c?c.prototype:null}}}}},{}],19:[function(f,h,g){h.exports=function i(a){return Object.prototype.toString.call(a)==="[object Date]"
}},{}],20:[function(k,j,g){var h=Object.prototype.hasOwnProperty;j.exports=function i(b){var a;
if(typeof b!=="object"){throw new TypeError("ac-base.Object.isEmpty : Invalid parameter - expected object")
}for(a in b){if(h.call(b,a)){return false}}return true}},{}],21:[function(i,h,f){h.exports=function g(a){return window.RegExp?a instanceof RegExp:false
}},{}],22:[function(k,i,g){var h=k("qs");i.exports=function j(a){if(typeof a!=="object"){throw new TypeError("toQueryParameters error: argument is not an object")
}return h.stringify(a)}},{qs:12}],23:[function(f,h,g){var i=f("./ac-element-engagement/ElementEngagement");
h.exports=new i();h.exports.ElementEngagement=i},{"./ac-element-engagement/ElementEngagement":24}],24:[function(t,u,q){var p;
...
},this)};u.exports=v},{"ac-base":false,"ac-element-tracker":9,"ac-object":13}],25:[function(k,i,g){var j={cssPropertyAvailable:k("./ac-feature/cssPropertyAvailable"),localStorageAvailable:k("./ac-feature/localStorageAvailable")};
...
};i.exports=j},{"./ac-feature/cssPropertyAvailable":26,"./ac-feature/localStorageAvailable":27}],26:[function(o,m,i){var l=null;
...
}}return false}}},{}],27:[function(j,i,g){var h=null;i.exports=function k(){if(h===null){h=!!(window.localStorage&&window.localStorage.non_existent!==null)
}return h}},{}],28:[function(d,g,f){g.exports=d(12)},{}],29:[function(d,g,f){g.exports=d(13)
},{"./ac-object/clone":30,"./ac-object/create":31,"./ac-object/defaults":32,"./ac-object/extend":33,"./ac-object/getPrototypeOf":34,"./ac-object/isDate":35,"./ac-object/isEmpty":36,"./ac-object/isRegExp":37,"./ac-object/toQueryParameters":38}],30:[function(d,g,f){g.exports=d(14)
},{"./extend":33}],31:[function(d,g,f){g.exports=d(15)},{}],32:[function(d,g,f){g.exports=d(16)
},{"./extend":33}],33:[function(d,g,f){g.exports=d(17)},{}],34:[function(d,g,f){g.exports=d(18)
},{}],35:[function(d,g,f){g.exports=d(19)},{}],36:[function(d,g,f){g.exports=d(20)
},{}],37:[function(d,g,f){g.exports=d(21)},{}],38:[function(d,g,f){g.exports=d(22)
},{qs:28}],39:[function(j,i,k){var h=j("./s-code/s-code");var g=j("./s-code/plugins");
i.exports.init=h;i.exports.plugins=g},{"./s-code/plugins":40,"./s-code/s-code":53}],40:[function(f,i,g){function h(a){f("./plugins/utilities/utilities")(a);
...
}},{}],44:[function(d,g,f){g.exports=function(a){a.downloadLinkHandler=new Function("p","var s=this,h=s.p_gh(),n='linkDownloadFileTypes',i,t;if(!h||(s.linkType&&(h||s.linkName)))return '';i=h.indexOf('?');t=s[n];s[n]=p?p:t;if(s.lt(h)=='d')s.linkType='d';else h='';s[n]=t;return h;")
}},{}],45:[function(d,g,f){g.exports=function(a){a.getAndPersistValue=new Function("v","c","e","var s=this,a=new Date;e=e?e:0;a.setTime(a.getTime()+e*86400000);if(v)s.c_w(c,v,e?a:0);return s.c_r(c);");
...
}},{}],49:[function(d,g,f){g.exports=function(a){a.getValOnce=new Function("v","c","e","var s=this,a=new Date,v=v?v:v='',c=c?c:c='s_gvo',e=e?e:0,k=s.c_r(c);if(v){a.setTime(a.getTime()+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v")
...
}())},{}],54:[function(i,h,f){var g=i("./ac-s-code/sCode");h.exports={init:g.init,getInstance:g.getInstance}
},{"./ac-s-code/sCode":68}],55:[function(d,g,f){(function(){function a(b){var i="";
...
}g.exports=a})()},{}],56:[function(d,g,f){(function(){var a=d("../plugin/sCodePlugins");
...
y="; expires = "+w.toGMTString();document.cookie="s_vnum_n2_us = "+v+y+"; domain = apple.com; path = /"
}var z=u.c_r("s_vi");if(z){w=new Date();w.setTime(w.getTime()+63072000000);y="; expires = "+w.toGMTString();
document.cookie="s_vi = "+z+y+"; domain = apple.com; path = /"}var t=u.c_r("s_pv");
if(t){y=";expires = Thu, 01 Jan 1970 00:00:01 GMT";document.cookie="s_pv = "+t+y+"; domain = apple.com; path = /"
...
u.dc=c.getDataCenterId()}g.exports=b})()},{"../plugin/sCodePlugins":67,"./../plugin/helper/dynamicObjectIdHandlerSafari":61,"./helper/browser":57,"./server":58}],57:[function(d,g,f){(function(){function a(){if(navigator&&navigator.loadPurpose&&navigator.loadPurpose==="preview"){return true
...
}}return false}g.exports={isSafariTopSitesPreview:a,isSafari:b}})()},{}],58:[function(d,g,f){(function(){var a=["www.apple.com","images.apple.com","movies.apple.com","ssl.apple.com"];
...
})()},{}],59:[function(d,g,f){(function(){function a(c){var i=c.u.match(/(iphone|ipod|ipad|android|kindle|silk-accelerated)/i);
...
}g.exports=a}())},{}],60:[function(d,g,f){(function(){function a(b){if(b.pageName){var c=escape(b.pageName);
c=c.replace(/(%u2018|%u2019|%u02BC|%u02BD)/g,"%27");c=c.replace(/(%u201C|%u201D|%E2%80%9C|%E2%80%9D)/g,"%22");
c=c.replace(/(%09|%0A|%0D)/g,"");b.pageName=unescape(c)}}g.exports=a}())},{}],61:[function(d,g,f){(function(){function a(c,b){if(c.lt(b.href)){b.addEventListener("mouseup",function(l){if(((l.which)&&(l.which===1))||((l.button)&&(l.button===1))){var k=l.currentTarget.href;
...
c.linkTrackEvents="None"}},false)}}g.exports=a}())},{}],62:[function(d,g,f){(function(){function a(W){var N=new Date();
...
return M+"="+1}}}}g.exports=a}())},{}],63:[function(d,g,f){(function(){function a(j){var c;
...
}())},{}],64:[function(d,g,f){(function(){function a(r){if(!r.prop17){var i=r.getPercentPageViewed(r.pageName);
...
},{}],65:[function(d,g,f){(function(){function a(p){if(((p.pageName&&p.prop14&&p.pageName.toLowerCase()!==p.prop14.toLowerCase())||!p.prop14)&&p.tcall){var v;
...
p.c_w("s_pathLength",q,b);p.prop48="1"}}}g.exports=a}())},{}],66:[function(d,g,f){(function(){function a(v){if(v.tcall){var x;
...
}())},{}],67:[function(d,g,f){(function(){var p=d("./helper/plpChannel");var q=d("./helper/cleanPageName");
...
if(typeof(q)==="function"){q(F)}var k="/(apple.com/retail/.+/map/|apple.com/buy/locator/|discussions.apple.com|discussionsjapan.apple.com)/g";
...
}F.linkLeaveQueryString=true;var i=F.linkHandler("itms.apple.com|itunes.apple.com","e");
...
}g.exports=b})()},{"./helper/QTCheck":59,"./helper/cleanPageName":60,"./helper/getVisitNumPerChannel":62,"./helper/osDetect":63,"./helper/percentPageViewed":64,"./helper/plpChannel":65,"./helper/setMembership":66}],68:[function(d,g,f){(function(){var m=d("s-code");
...
}g.exports={init:b,getInstance:c}}())},{"./config/account":55,"./config/defaults":56,"s-code":39}],69:[function(p,n,k){var m="ac-storage-";
var q=p("./ac-storage/Item");var l=p("./ac-storage/Storage");var j=p("./ac-storage/Storage/storageAvailable");
var o=new l(m);o.Item=q;o.storageAvailable=j;n.exports=o},{"./ac-storage/Item":70,"./ac-storage/Storage":77,"./ac-storage/Storage/storageAvailable":79}],70:[function(u,w,o){var x=u("ac-base").adler32;
...
}};t.createExpirationDate=v;w.exports=t},{"./Item/apis":71,"./Item/createExpirationDate":74,"./Item/encoder":75,"ac-base":false}],71:[function(n,l,i){var k=n("ac-base").log;
...
return true}});return a}};l.exports=m},{"./apis/localStorage":72,"./apis/userData":73,"ac-base":false}],72:[function(p,o,j){var k=p("ac-base").Environment.Feature;
...
return true}};o.exports=q},{"ac-base":false}],73:[function(p,o,q){var n=p("ac-base").Element;
...
}return this._element}};o.exports=j},{"ac-base":false}],74:[function(g,k,h){var i=1000*60*60*24;
...
}b.setTime(b.getTime()+(a*i));return b.getTime()};k.exports=j},{}],75:[function(g,k,h){var i=g("./encoder/compressor");
...
}return false}catch(a){return false}}};k.exports=j},{"./encoder/compressor":76}],76:[function(h,m,i){var j=1000*60*60*24;
...
},offsetDaysToMilliseconds:function(a){return(a+l)*j}};m.exports=k},{}],77:[function(n,m,p){var q=n("ac-base").Object;
...
}var a=j.item(this.namespace()+b);return a}};m.exports=l},{"./Item/apis/localStorage":72,"./Storage/registry":78,"ac-base":false}],78:[function(k,j,m){var l=k("../Item");
...
}};j.exports=i},{"../Item":70}],79:[function(m,k,i){var l=m("../Item/apis");var j;
k.exports=function h(){if(j!==undefined){return j}j=!!l.best();return j}},{"../Item/apis":71}],"++O3BW":[function(d,g,f){g.exports={observer:{Audio:d("./ac-analytics/observer/Audio"),Click:d("./ac-analytics/observer/Click"),Event:d("./ac-analytics/observer/Event"),Exit:d("./ac-analytics/observer/Exit"),Gallery:d("./ac-analytics/observer/Gallery"),Link:d("./ac-analytics/observer/Link"),Overlay:d("./ac-analytics/observer/Overlay"),Page:d("./ac-analytics/observer/Page"),Section:d("./ac-analytics/observer/Section"),Video:d("./ac-analytics/observer/Video")},regions:d("./ac-analytics/regions/regions")}
},{"./ac-analytics/observer/Audio":89,"./ac-analytics/observer/Click":90,"./ac-analytics/observer/Event":91,"./ac-analytics/observer/Exit":92,"./ac-analytics/observer/Gallery":93,"./ac-analytics/observer/Link":94,"./ac-analytics/observer/Overlay":95,"./ac-analytics/observer/Page":96,"./ac-analytics/observer/Section":97,"./ac-analytics/observer/Video":98,"./ac-analytics/regions/regions":121}],"ac-analytics":[function(d,g,f){g.exports=d("++O3BW")
},{}],82:[function(r,t,p){var o;var l=r("ac-base").Array;var n=r("./error-handler/ErrorHandler");
var m=r("ac-storage");var k="analytics-queue";function q(){this._storage=m;this._arr=[];
...
};t.exports=q},{"./error-handler/ErrorHandler":86,"ac-base":false,"ac-storage":69}],83:[function(v,w,r){var q;
...
}if(o.exception){return}b();a.resolve();return a.promise()};w.exports=p},{"./Queue":82,"./error-handler/ErrorHandler":86,"./plugins/plugins":99,"./translator/translator":132,"ac-deferred":false}],84:[function(p,o,j){var n;
...
}};o.exports=m},{"../error-handler/ErrorHandler":86,"ac-base":false}],85:[function(d,g,f){(function(){function a(c){var k;
var j={};var b;if(c&&c.length>0){k=c.split(",");if(k&&k.length>0){k.forEach(function(h){b=h.split(":");
j[b[0]]=b[1]})}}return j}g.exports={dataStringToObject:a}}())},{}],86:[function(n,m,o){var l;
...
d=(a||"")+f+(b||"")+g}return k+g+d+h};m.exports=new i()},{"ac-console":1}],87:[function(d,g,f){(function(){var F=d("ac-base").Array;
...
}if(D.exception){return}return i.split(h)}b=L(E);g.exports=H(b)}())},{"./error-handler/ErrorHandler":86,"ac-base":false}],88:[function(f,h,g){var i=f("./Tracker");
h.exports=new i("sCode");h.exports.Tracker=i},{"./Tracker":83}],89:[function(w,x,t){var r;
...
};x.exports=o},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-base":false,"ac-dom-events":3,"ac-object":29}],90:[function(z,B,v){var u;
...
};B.exports=A},{"../controller/Touch":84,"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-base":false,"ac-dom-events":3,"ac-feature":25,"ac-object":29}],91:[function(t,u,p){var o;
...
};u.exports=m},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-object":29}],92:[function(u,v,q){var p;
...
};v.exports=m},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-base":false,"ac-object":29}],93:[function(y,z,v){var u;
...
z.exports=p},{"../error-handler/ErrorHandler":86,"../metadata":87,"../metricsTracker":88,"ac-base":false,"ac-dom-events":3,"ac-object":29}],94:[function(v,w,q){var o=v("ac-base").Element;
...
}};w.exports=u},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-base":false,"ac-dom-events":3,"ac-object":29}],95:[function(t,u,p){var o;
...
};u.exports=m},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-object":29}],96:[function(q,r,n){var m;
...
},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-object":29}],97:[function(z,A,w){var v;
...
};A.exports=r},{"../data-attr/helper":85,"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-base":false,"ac-element-engagement":23,"ac-object":29}],98:[function(t,u,p){var o;
...
};u.exports=l},{"../error-handler/ErrorHandler":86,"../metricsTracker":88,"ac-object":29}],99:[function(d,g,f){g.exports={sCode:d("./s-code/sCode")}
},{"./s-code/sCode":104}],100:[function(d,g,f){(function(){var a=d("ac-base").Element;
...
}())},{"ac-base":false}],101:[function(d,g,f){(function(){var x=d("../../../error-handler/ErrorHandler");
...
}())},{"../../../error-handler/ErrorHandler":86}],102:[function(d,g,f){(function(){var c=d("../../../error-handler/ErrorHandler");
...
}())},{"../../../error-handler/ErrorHandler":86,"./../../../metadata":87}],103:[function(d,g,f){(function(){var c=d("./formatter");
...
}})}return j}g.exports={set:a,translate:b}}())},{"./formatter":101}],104:[function(D,F,B){var x;
...
};F.exports=y},{"../../error-handler/ErrorHandler":86,"../../metadata":87,"./helpers/formatter":101,"./helpers/metadata":102,"./helpers/templateVar":103,"./submit-methods/submitMethods":106,"./translator/translator":119,"ac-object":29,"ac-s-code":54}],105:[function(d,g,f){(function(){function b(p,r,u){var t=window.location.href;
...
}g.exports=b}())},{}],106:[function(m,j,h){var k=m("./t");var i=m("./tl");var l=m("./manual");
j.exports={t:k,tl:i,manual:l}},{"./manual":105,"./t":107,"./tl":108}],107:[function(d,g,f){(function(){function a(b,c,i){if(typeof i==="object"&&typeof i.t==="function"){i.pageName=c.pageName;
i.channel=c.channel;i.t()}}g.exports=a}())},{}],108:[function(d,g,f){(function(){var p=d("../../../error-handler/ErrorHandler");
...
var j=q.isIntraPageLink(h);if(!h||j===true){i=false}return i}g.exports=m}())},{"../../../error-handler/ErrorHandler":86,"../helpers/DOM":100}],109:[function(d,g,f){(function(){var b=d("../../helpers/formatter");
...
}())},{"../../helpers/formatter":101}],110:[function(d,g,f){(function(){var b=d("ac-storage");
...
}g.exports={translate:a}}())},{"../../../../data-attr/helper":85,"../../helpers/DOM":100,"../../helpers/formatter":101,"ac-storage":69}],111:[function(d,g,f){(function(){var c=d("../../helpers/formatter");
...
}}u.properties=r;u.submitMethod="tl";return u}g.exports={translate:a}}())},{"../../helpers/formatter":101,"../../helpers/templateVar":103}],112:[function(d,g,f){(function(){var b=d("../../helpers/formatter");
...
return u}g.exports={translate:a}}())},{"../../helpers/formatter":101}],113:[function(d,g,f){(function(){var k=d("../../../../error-handler/ErrorHandler");
...
}g.exports={translate:a}}())},{"../../../../error-handler/ErrorHandler":86,"../../helpers/formatter":101}],114:[function(d,g,f){(function(){var b=d("ac-storage");
...
C.submitMethod="tl";return C}g.exports={translate:a}}())},{"../../helpers/DOM":100,"../../helpers/formatter":101,"ac-storage":69}],115:[function(d,g,f){(function(){var b=d("../../helpers/formatter");
function a(l,m,c){var o=l;var n={};o.properties=n;o.submitMethod="tl";return o}g.exports={translate:a}
}())},{"../../helpers/formatter":101}],116:[function(d,g,f){(function(){var j=d("ac-storage");
...
}return h}g.exports={translate:b}}())},{"../../helpers/formatter":101,"../../helpers/templateVar":103,"ac-storage":69}],117:[function(d,g,f){(function(){function a(u,q,v){var x=u;
...
}())},{}],118:[function(d,g,f){(function(){var c=d("../../helpers/formatter");function a(w,q,x){var y=w;
...
}g.exports={translate:a}}())},{"../../helpers/formatter":101}],119:[function(d,g,f){(function(){var b={audio:d("./component/audio"),gallery:d("./component/gallery"),link:d("./component/link"),click:d("./component/click"),overlay:d("./component/overlay"),page:d("./component/page"),section:d("./component/section"),video:d("./component/video"),exit:d("./component/exit"),event:d("./component/event")};
function a(k,m,c){var l=k;if(k.type&&b[k.type]){l=b[k.type].translate(k,m,c)}return l
}g.exports={translate:a,components:b}}())},{"./component/audio":109,"./component/click":110,"./component/event":111,"./component/exit":112,"./component/gallery":113,"./component/link":114,"./component/overlay":115,"./component/page":116,"./component/section":117,"./component/video":118}],120:[function(r,t,q){var p;
...
},{"../data-attr/helper":85}],121:[function(d,g,f){(function(){var v=d("ac-base").Element;
...
}())},{"./Region":120,"ac-base":false}],122:[function(d,g,f){(function(){var b=d("ac-base").Element;
...
return o}g.exports={translate:c}}())},{"ac-base":false,"ac-dom-events":3}],123:[function(d,g,f){(function(){var b=d("ac-base").Element;
...
},{"../../regions/regions":121,"ac-base":false}],124:[function(d,g,f){(function(){function a(b){var c=b;
return c}g.exports={translate:a}}())},{}],125:[function(d,g,f){(function(){function a(b){var c=b;
return c}g.exports={translate:a}}())},{}],126:[function(d,g,f){(function(){var n=d("ac-base").Element;
...
}return j}g.exports={translate:r}}())},{"ac-base":false}],127:[function(d,g,f){(function(){var b=d("ac-base").Element;
var a=d("../../regions/regions");function c(m){var o=m;var q=b.select("img",m.data.targetEl);
...
}())},{"../../regions/regions":121,"ac-base":false}],128:[function(d,g,f){(function(){function a(b){var c=b;
return c}g.exports={translate:a}}())},{}],129:[function(d,g,f){(function(){function a(b){var c=b;
return c}g.exports={translate:a}}())},{}],130:[function(d,g,f){(function(){function a(b){return b
}g.exports={translate:a}}())},{}],131:[function(d,g,f){(function(){var c={play:function(i){if(i.data.ended===true){return"replay"
...
}return k}g.exports={translate:b}}())},{}],132:[function(d,g,f){(function(){var c=d("../error-handler/ErrorHandler");
