...
}else{c=AC.Retina.imageComponentRegistry.lookup("img-tag")}}}g.setSrc(h||"http://images.apple.com/global/elements/blank.gif");
...
}AC.Retina.imageComponentRegistry.addComponent("_base",{ignoreRegex:/(^http:\/\/movies\.apple\.com\/|\/105\/|\/media\/|\/global(\/ac_media_player)?\/elements\/quicktime\/|_(([2-9]|[1-9][0-9]+)x|nohires)(\.[a-z]+)($|#.*|\?.*))/i,filenameRegex:/(.*)(\.[a-z]{3}($|#.*|\?.*))/i,filenameInsert:"_☃x",hiresFormat:false,cleanHiresSrc:true,preload:false,checkExists:true,checkAsRootRelative:true},AC.Function.emptyFunction,null,{src:function ac_src(){return""
...
AC.Retina.sharedInstance();require=(function e(b,g,d){function c(k,i){if(!g[k]){if(!b[k]){var h=typeof require=="function"&&require;
if(!i&&h){return h(k,!0)}if(a){return a(k,!0)}throw new Error("Cannot find module '"+k+"'")
}var j=g[k]={exports:{}};b[k][0].call(j.exports,function(l){var m=b[k][1][l];return c(m?m:l)
},j,j.exports,e,b,g,d)}return g[k].exports}var a=typeof require=="function"&&require;
...
}var l=new i(m.promo,m.weight);return l};c.exports=i},{"ac-base":false}],17:[function(b,d,a){var c=b("../shared/FeatureDetect");
var f=(function(){return{initialize:function(){c.htmlClass();return this}}}());
d.exports=f.initialize()},{"../shared/FeatureDetect":18}],18:[function(b,f,a){var g=b("ac-base").Element;
